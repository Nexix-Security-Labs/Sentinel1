...
then
    ...
    egrep '<Product Id="\*" Name="Sentinel Agent" Language="1033" Version=".+" Manufacturer=' $MSI_FILE > /dev/null
    ...
    sed -E -i'' -e "s/(<Product Id=\"\*\" Name=\"Sentinel Agent\" Language=\"1033\" Version=\").+(\" Manufacturer=)/\1${version:1}\2/g" $MSI_FILE
